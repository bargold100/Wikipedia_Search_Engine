...
class InvertedIndex:  
    def __init__(self, docs={}):
        ...
        self.doc_length = defaultdict(list)
        self.doc_norma = defaultdict(list)
        self.N = None
    ...
    def write_a_posting_list(b_w_pl, bucket_name, index_name):
        ...
        with closing(MultiFileWriter(".", index_name+str(bucket_id), bucket_name)) as writer:
            ...
            InvertedIndex._upload_posting_locs(index_name+str(bucket_id), posting_locs, bucket_name)
        return index_name+str(bucket_id)
